...
insert into products (name, description, merken, quantity, code, price) values ('Samyang Hot chicken ramen cheese', 'Nulla ut erat id mauris vulputate elementum. Nullam varius.', 'Buldak', '140', '077030122-3', 1.61);
insert into products (name, description, merken, quantity, code, price) values ('Samyang Hot chicken ramen, 2x spicy', 'Pellentesque at nulla. Suspendisse potenti.','Buldak', '140', '445924201-X', 1.19);
